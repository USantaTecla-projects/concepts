package com.example.backend.e2e.resources.exam.domain.family.question.exception;

import com.example.backend.e2e.exception.specific.ExceptionDTO;
import com.example.backend.e2e.resources.exam.domain.family.question.exception.specific.QuestionNotFoundException;
import com.example.backend.e2e.resources.exam.domain.family.question.exception.specific.NotEnoughDataException;
import com.example.backend.e2e.resources.exam.domain.family.question.exception.specific.QuestionDTOBadRequestException;
import com.example.backend.e2e.resources.exam.domain.family.question.exception.specific.QuestionTypeDetailsNotFoundException;
