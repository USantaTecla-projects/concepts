package com.example.backend.e2e.resources.exam.exception;


import com.example.backend.e2e.exception.specific.ExceptionDTO;
import com.example.backend.e2e.resources.exam.exception.specific.CreateExamDTOBadRequestException;
