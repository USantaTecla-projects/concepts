package com.example.backend.e2e.resources.exam.domain.factory.concrete;

import com.example.backend.e2e.resources.exam.domain.family.answer.tools.saver.AnswerSaver;
import com.example.backend.e2e.resources.exam.domain.family.answer.tools.saver.specific.AnswerT3Saver;
import com.example.backend.e2e.resources.exam.domain.family.answer.tools.mapper.AnswerMapper;
import com.example.backend.e2e.resources.exam.domain.family.answer.tools.mapper.specific.AnswerT3Mapper;
import com.example.backend.e2e.resources.exam.domain.family.answer.repository.AnswerT3Repository;
import com.example.backend.e2e.resources.exam.domain.family.question.tools.filler.QuestionFiller;
import com.example.backend.e2e.resources.exam.domain.family.question.tools.filler.specific.QuestionT3Filler;
import com.example.backend.e2e.resources.exam.domain.family.question.tools.mapper.QuestionMapper;
import com.example.backend.e2e.resources.exam.domain.family.question.tools.mapper.specific.QuestionT3Mapper;
import com.example.backend.e2e.resources.exam.domain.family.question.repository.QuestionT3Repository;
import com.example.backend.e2e.resources.exam.domain.factory.TypeFactory;
