package com.example.backend.api.resources.exam.question;

import com.example.backend.api.resources.exam.question.exception.model.NotEnoughDataException;
...
import com.example.backend.api.resources.exam.type.factory.TypeFactoryProvider;
...
public class QuestionService {
    ...
    public List<Question> createQuestions(final int numberOfQuestions) {
        ...
        while (questions.size() < numberOfQuestions) {
            ...
            try {
                filler.fillQuestion(question, questions);
